		...
		<div :style='{"padding":"20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"0","flexDirection":"column","background":"none","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 45px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) center center/100% 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"padding":"0 0 10px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"10px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"84px"}'>
					...
					<div :style='{"margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250104/f33d5d50e8f84eca902cf5cfcbf23edf.png) center center/100% 100%","flexDirection":"column","flex":"0 1 auto","display":"flex","width":"175px","position":"relative","justifyContent":"center","height":"100%","maxWidth":"175px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexDirection":"column","display":"flex","width":"100%","justifyContent":"center","height":"100%"}'>
							<div :style='{"lineHeight":"24px","fontSize":"12px","position":"relative","color":"inherit","height":"24px"}'>全国职位总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"16px","color":"rgb(30, 144, 255)","fontWeight":"bold","height":"24px","order":"20"}'>{{zhipindsjCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts6">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart6" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts7">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<el-table id="zhipindsjTable" :data="zhipindsjList" border :stripe="true" :style='{"padding":"0","borderColor":"#eee","overflow":"auto","borderWidth":"0","background":"none","width":"100%","borderStyle":"solid","height":"calc(100% - 65px)"}'>
						<el-table-column :resizable="true" :sortable="false" prop="brandname" label="公司名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jobname" label="职位名称">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="brandlogo" label="公司LOGO">
							<template slot-scope="scope">
								<div v-if="scope.row.brandlogo">
									<img v-if="scope.row.brandlogo.substring(0,4)=='http'&&scope.row.brandlogo.split(',w').length>1" :src="scope.row.brandlogo" width="30" height="30">
									<img v-else-if="scope.row.brandlogo.substring(0,4)=='http'" :src="scope.row.brandlogo.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.brandlogo.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="cityname" label="城市">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jobdegree" label="学历">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="jobexperience" label="工作经验">
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"padding":"0","flexWrap":"wrap","flexDirection":"column","background":"none","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts4">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts5">
					<div :style='{"padding":"0 0 0 40px","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250103/a6c3848945ee42adbb690d642254926d.png) no-repeat left center/auto 100%","width":"100%","lineHeight":"40px","height":"55px"}'>
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="zhipindsjChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
		...
		methods:{
			getzhipindsjList() {
				...
				this.$http({
					...
					if (data && data.code === 0) {
						this.zhipindsjList = data.data.list;
						let div = document.getElementById('zhipindsjTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.zhipindsjTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.zhipindsjTimer);
						})
				...
				this.$nextTick(()=>{
					...
					this.$http({
						...
						if (data && data.code === 0) {
							...
							var option = {};
							this.wordclouds(pArray,'zhipindsjChart6');
