<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0","margin":"0 0 0 64px","position":"relative","display":"block"} : {"minHeight":"100%","padding":"70px 0 0 230px","margin":"0","position":"relative","background":"#E6E6E6","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"border":"1px dashed  #E6E6E6","padding":"0 20px 0 0","alignItems":"center","color":"#FFFFFF","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#02a79c","width":"100%","fontSize":"16px","position":"fixed","zIndex":"1001","height":"70px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"20px 40px","margin":"0px auto 20px 20px","borderColor":"#3b6885","alignItems":"center","display":"flex","borderWidth":"0 0 0px 0","background":"#fff","width":"calc(100% - 40px)","fontSize":"14px","position":"fixed","borderStyle":"solid","fontWeight":"400","height":"40px","zIndex":"2"}' class="bread-crumbs"></bread-crumbs>
