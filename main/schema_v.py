...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spidervo92772u && scrapy crawl "+tableName+"Spider -a databaseName=djangosk189641"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=djangosk189641"
        os.system(cmd)
