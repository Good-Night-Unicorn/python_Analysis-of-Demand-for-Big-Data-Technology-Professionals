...
class zhipindsj(BaseModel):
    __doc__ = u'''zhipindsj'''
    __tablename__ = 'zhipindsj'
    ...
    __isAdmin__='否'#表属性isAdmin=”是”,刷出来的用户表也是管理员，即page和list可以查看所有人的考试记录(同时应用于其他表)
    addtime = models.DateTimeField(auto_now_add=False, verbose_name=u'创建时间')
    brandname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='公司名称' )
    jobname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='职位名称' )
    brandlogo=models.TextField   (  null=True, unique=False, verbose_name='公司LOGO' )
    cityname=models.CharField ( max_length=255, null=True, unique=False, verbose_name='城市' )
    jobdegree=models.CharField ( max_length=255, null=True, unique=False, verbose_name='学历' )
    jobexperience=models.CharField ( max_length=255, null=True, unique=False, verbose_name='工作经验' )
    salarydesc=models.CharField ( max_length=255, null=True, unique=False, verbose_name='待遇描述' )
    brandIndustry=models.CharField ( max_length=255, null=True, unique=False, verbose_name='公司类型' )
    brandscalename=models.CharField ( max_length=255, null=True, unique=False, verbose_name='公司规模' )
    bosstitle=models.CharField ( max_length=255, null=True, unique=False, verbose_name='老板职务' )
    welfarelist=models.TextField   (  null=True, unique=False, verbose_name='福利' )
    skills=models.TextField   (  null=True, unique=False, verbose_name='技能要求' )
    ...
    salarydesc=VARCHAR
    brandIndustry=VARCHAR
    brandscalename=VARCHAR
    bosstitle=VARCHAR
    welfarelist=Text
    skills=Text
    detailurl=Text
    ...
    class Meta:
        db_table = 'zhipindsj'
        verbose_name = verbose_name_plural = '全国职位'
class newstype(BaseModel):
    ...
    class Meta:
        db_table = 'newstype'
        verbose_name = verbose_name_plural = '公告栏分类'
